...
static const std::string warning_codes[] = {
	...
	"LOAD_UNUSED_LIST",
	"LOAD_UNKNOWN_ITEM",
	"LOAD_ENGINE_VERSION_NUMERIC_LITERAL"
};
...
static const std::string warning_strings[] = {
	...
	"Numeric literal in engine version"
};
...
static const std::string warning_descs[] = {
	...
	"The required engine version contains a numeric literal. This was the legacy way to express engine versions. Use the new semver string format instead."
};
